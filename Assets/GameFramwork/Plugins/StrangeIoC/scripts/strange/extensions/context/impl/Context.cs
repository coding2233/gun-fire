...
namespace strange.extensions.context.impl
{
	public class Context : Binder, IContext
	{
		...
		public HashSet<IContext> contextChildren;
		...
		virtual public IContext AddContext(IContext context)
		{
			...
			{
				contextChildren = new HashSet<IContext>();
            }
			if (!contextChildren.Contains(context))
			{
				contextChildren.Add(context);
			}
		...
		virtual public IContext RemoveContext(IContext context)
		{
		    ...
		    else
		    {
                if (contextChildren.Contains(context))
                {
                    contextChildren.Remove(context);
                }
                context.OnRemove();
		    }
		    return this;
