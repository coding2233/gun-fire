...
namespace CodeGenerator
{
    internal static class Program
    {
        ...
        [MenuItem("Tools/Dear ImGui Code Generator")]
        static void RunCodeGenerator()
        {
            Main(new string[] { "Assets/GameFramwork/Runtime/DearImGui/Generated" });
        }
        ...
        static void Main(string[] args)
        {
            ...
            string definitionsPath = Path.Combine("Assets/GameFramwork/Editor/DearImGui/CodeGenerator", "definitions", libraryName);// AppContext.BaseDirectory
